...
// USING LEVEL ORDER TRAVERSAL using reverse preorder
...
// USING LEVEL ORDER TRAVERSAL using Preoder
...
int main() {
	...
	vector<int>ans = solve3(root);

	// vector<int>ans;
	// solve2(root, ans, 1);

	cout << "The Right View Of Binary tree : ";
	for (auto q : ans) {
		cout << q << " ";
	}
	cout << "\n";
